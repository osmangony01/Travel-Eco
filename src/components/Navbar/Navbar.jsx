...
const Navbar = () => {
    ...
    return (
        <nav className="flex justify-between items-center py-5 px-10 mx-auto bg-white">
            <h1 className="text-2xl font-semibold">TravelEco</h1>
            <ul className="flex items-center justify-center">
                ...
                <li className="mx-2"><ActiveLink to="/hotel">Hotel</ActiveLink></li>
                <li className="mx-2"><ActiveLink to="/place">Destination</ActiveLink></li>
                <li className="mx-2"><ActiveLink to="/about-us"> About us</ActiveLink></li>
                {!user && <li className="mx-2"><ActiveLink to="/sign-in">Sign In</ActiveLink></li>}
