...
const HotelList = () => {
    ...
    return (
        <div className=' w-full lg:w-[1000px] mx-auto border px-12 pt-6 pb-10 bg-white mt-3 h-full'>
            <h1 className='text-2xl text-center pb-8 font-semibold'>Hotel list</h1>
            <div>
                <button className='px-4 py-1.5 border border-blue-500 rounded my-4 font-semibold text-blue-500 hover:text-white hover:bg-blue-700'><Link to="/admin/add-hotel">Add Hotel</Link></button>

                <div className='overflow-x-auto w-full '>
                    <table className='table w-full'>
                        {hotel?.length >= 1 && <thead className='bg-blue-100'>
                            <tr>
                                <th className='border p-3 text-center'>#</th>
                                <th className='border p-3 text-center'>Hotel Name</th>
                                <th className='border p-3 text-center'>Hotel price</th>
                                <th className='border p-3 text-center'>Hotel rating</th>
                        ...
                        <tbody>
                            {
                                hotel.map((item, index) => {
                                    return <tr>
                                        ...
                                        <td className='border p-2'>{item.hotel_name}</td>
                                        <td className='border p-2'>{item.hotel_price}</td>
                                        <td className='border p-2'>{item.hotel_rating}</td>
